 ...
 * @author ADMIN
 */
public class ViewThemKhach extends javax.swing.JFrame {

    public Nhanvien nv;
    
    /**
     * Creates new form ViewThemKhach
     */
    public ViewThemKhach(Nhanvien nv) {
        this.nv=nv;
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        kh.setTen(jTextField1.getText());
        kh.setTuoi(Integer.parseInt(jTextField2.getText()));
        kh.setDc(jTextField3.getText());
        kh.setCmnd(jTextField4.getText());
        kh.setSdt(jTextField5.getText());
        kh.setMota(jTextField6.getText());
        KhachhangDAO khdao=new KhachhangDAO();
        if(khdao.ThemKhach(kh)){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewThemKhach.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
